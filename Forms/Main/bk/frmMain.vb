...
Partial Friend Class frmMain1
    Dim ret As Boolean
    Dim pProcessEnable As Boolean
    Private Const MaxNamTC As Integer = 9
    Private Const OptLDBLoggedUsers As Integer = &H2S
    ' Menu nhap chung tu
    Private nhapChungTuContextMenuStrip As ContextMenuStrip
    ' Menu bao cao chi tiet
    Private baoCaoChiTietContextMenuStrip As ContextMenuStrip
...
#Region "Nhap chung tu menu"

    ''' Phuong thuc tao menu Nhap chung tu
    Private Sub nhapChungTuMenu()
        Try
            'khoi tao menu
            nhapChungTuContextMenuStrip = New ContextMenuStrip()
            nhapChungTuContextMenuStrip.Font = New Font(nhapChungTuContextMenuStrip.Font.Name, 10, FontStyle.Bold)
            AddHandler nhapChungTuContextMenuStrip.Opening, AddressOf nhapChungTu_TongHop
            btnNhapChungTuTongHop.ContextMenuStrip = nhapChungTuContextMenuStrip
    ...
    Private Sub nhapChungTu_TongHop(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs)
        Try
            nhapChungTuContextMenuStrip.Items.Clear()
            ' Populate the ContextMenuStrip control with its default items.

            Dim tonghop_menu As ToolStripItem = nhapChungTuContextMenuStrip.Items.Add(Ngonngu("Tổng hợp", "General"))
            tonghop_menu.ForeColor = Color.Blue
            tonghop_menu.Visible = False
            AddHandler tonghop_menu.Click, AddressOf tonghop_menu_click
            Dim nhapvattu_menu As ToolStripItem = nhapChungTuContextMenuStrip.Items.Add(Ngonngu("Nhập vật tư", "Import supplies"))
            AddHandler nhapvattu_menu.Click, AddressOf nhapvattu_menu_click
            Dim tangtaisan_menu As ToolStripItem = nhapChungTuContextMenuStrip.Items.Add(Ngonngu("Tăng tài sản cố định", "Increase fixed assets"))
            AddHandler tangtaisan_menu.Click, AddressOf tangtaisan_menu_click
            Dim tangcongcudungcu_menu As ToolStripItem = nhapChungTuContextMenuStrip.Items.Add(Ngonngu("Tăng công cụ dụng cụ", "Increase tooling tools"))
            AddHandler tangcongcudungcu_menu.Click, AddressOf tangcongcudungcu_menu_click
            Dim xuatvattu_menu As ToolStripItem = nhapChungTuContextMenuStrip.Items.Add(Ngonngu("Xuất vật tư", "Exporting supplies"))
            AddHandler xuatvattu_menu.Click, AddressOf xuatvattu_menu_click
            Dim giamtaisan_menu As ToolStripItem = nhapChungTuContextMenuStrip.Items.Add(Ngonngu("Giảm tài sản cố định", "Decrease in fixed assets"))
            AddHandler giamtaisan_menu.Click, AddressOf giamtaisan_menu_click
            Dim banHang_menu As ToolStripItem = nhapChungTuContextMenuStrip.Items.Add(Ngonngu("Bán hàng", "Sell"))
            AddHandler banHang_menu.Click, AddressOf banHang_menu_click
            Dim danhgialai_menu As ToolStripItem = nhapChungTuContextMenuStrip.Items.Add(Ngonngu("Đánh giá lại", "Reevaluate"))
            AddHandler danhgialai_menu.Click, AddressOf danhgialai_menu_click
            Dim khauhaotaisan_menu As ToolStripItem = nhapChungTuContextMenuStrip.Items.Add(Ngonngu("Khấu hao tài sản", "Depreciation of assets"))
            AddHandler khauhaotaisan_menu.Click, AddressOf khauhaotaisan_menu_click
            Dim phanboccdc_menu As ToolStripItem = nhapChungTuContextMenuStrip.Items.Add(Ngonngu("Phân bổ công cụ dụng cụ", "Allocation of tools"))
            AddHandler phanboccdc_menu.Click, AddressOf phanboccdc_menu_click
            e.Cancel = False
        Catch ex As Exception
    ...
    Private Sub tonghop_menu_click()
        Try
        ...
        End Try
    End Sub
    Private Sub nhapvattu_menu_click()
        Try
            If (ChoNhapTiep()) Then
    ...
    Private Sub tangtaisan_menu_click()
        Try
            If ChoNhapTiep() Then
                Dim Index = 0
    ...
    Private Sub tangcongcudungcu_menu_click()
        Try
            If ChoNhapTiep() Then
                Dim Index = 0
                FrmChungtu.khoi_tao()
    ...
    Private Sub xuatvattu_menu_click()
        Try
            If ChoNhapTiep() Then
    ...
    Private Sub giamtaisan_menu_click()
        Try
            If ChoNhapTiep() Then
                Dim Index = 3
                FrmChungtu.initOption = IIf(Index = 0, 9, (IIf(Index = 3, 10, (IIf(Index = 5, 11, 12)))))
    ...
    Private Sub banHang_menu_click()
        Try
            If ChoNhapTiep() Then
    ...
    Private Sub danhgialai_menu_click()
        Try
            If ChoNhapTiep() Then
                Dim Index = 5
                FrmChungtu.initOption = IIf(Index = 0, 9, (IIf(Index = 3, 10, (IIf(Index = 5, 11, 12)))))
    ...
    Private Sub khauhaotaisan_menu_click()
        Try
            If ChoNhapTiep() Then
                Dim Index = 6
                FrmChungtu.initOption = IIf(Index = 0, 9, (IIf(Index = 3, 10, (IIf(Index = 5, 11, 12)))))
    ...
    Private Sub phanboccdc_menu_click()
        Try
            If ChoNhapTiep() Then
                Dim Index = 6
                FrmChungtu.khoi_tao()
...
#End Region
#Region "Bao cao chi tiet menu"
    ''' Phuong thuc tao menu Bao cao chi tiet
    Private Sub baoCaoChiTietMenu()
        Try
            'khoi tao menu
            baoCaoChiTietContextMenuStrip = New ContextMenuStrip()
            baoCaoChiTietContextMenuStrip.Font = New Font(baoCaoChiTietContextMenuStrip.Font.Name, 10, FontStyle.Bold)
            AddHandler baoCaoChiTietContextMenuStrip.Opening, AddressOf baoCao_chitiet
            btnBaoCaoChiTiet.ContextMenuStrip = baoCaoChiTietContextMenuStrip
        Catch ex As Exception
            MessageBox.Show(ex.Message, Application.CompanyName, MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
    Private Sub baoCao_chitiet(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs)
        Try
            baoCaoChiTietContextMenuStrip.Items.Clear()
            Dim bcVatTuhanghoa_menu As ToolStripItem = baoCaoChiTietContextMenuStrip.Items.Add(Ngonngu("Vật tư hàng hóa", "Material goods"))
            'bcVatTuhanghoa_menu.ForeColor = Color.Blue
            AddHandler bcVatTuhanghoa_menu.Click, AddressOf bcVatTuhanghoa_menu_click

            Dim bcTaisancodinh_menu As ToolStripItem = baoCaoChiTietContextMenuStrip.Items.Add(Ngonngu("Tài sản cố định", "Fixed assets"))
            'bcTaisancodinh_menu.ForeColor = Color.Blue
            AddHandler bcTaisancodinh_menu.Click, AddressOf bcTaisancodinh_menu_click

            Dim bcCongcudungcu_menu As ToolStripItem = baoCaoChiTietContextMenuStrip.Items.Add(Ngonngu("Công cụ dụng cụ", "Tools and supplies"))
            'bcCongcudungcu_menu.ForeColor = Color.Blue
            AddHandler bcCongcudungcu_menu.Click, AddressOf bcCongcudungcu_menu_click

            Dim bcChiphitonghop_menu As ToolStripItem = baoCaoChiTietContextMenuStrip.Items.Add(Ngonngu("Chi phí tổng hợp", "Comprehensive cost"))
            'bcChiphitonghop_menu.ForeColor = Color.Blue
            AddHandler bcChiphitonghop_menu.Click, AddressOf bcChiphitonghop_menu_click

            Dim bcGiaThanh_menu As ToolStripItem = baoCaoChiTietContextMenuStrip.Items.Add(Ngonngu("Giá thành", "Cost price"))
            'bcGiaThanh_menu.ForeColor = Color.Blue
            AddHandler bcGiaThanh_menu.Click, AddressOf bcGiaThanh_menu_click

            Dim bcCongNo_menu As ToolStripItem = baoCaoChiTietContextMenuStrip.Items.Add(Ngonngu("Công nợ", "Liabilities"))
            'bcCongNo_menu.ForeColor = Color.Blue
            AddHandler bcCongNo_menu.Click, AddressOf bcCongNo_menu_click
        ...
        End Try
    End Sub
    Private Sub bcVatTuhanghoa_menu_click()
        Try
        ...
        End Try
    End Sub
    Private Sub bcTaisancodinh_menu_click()
        Try
            If pRpt = CheckState.Checked And User_Right = 1 Then
                ErrMsg(er_KoSD)
                Exit Sub
        ...
        End Try
    End Sub
    Private Sub bcCongcudungcu_menu_click()
        Try
            If pRpt = CheckState.Checked And User_Right = 1 Then
                ErrMsg(er_KoSD)
                Exit Sub
        ...
        End Try
    End Sub
    Private Sub bcChiphitonghop_menu_click()
        Try
            If pRpt = CheckState.Checked And User_Right = 1 Then
                ErrMsg(er_KoSD)
                Exit Sub
        ...
        End Try
    End Sub
    Private Sub bcGiaThanh_menu_click()
        Try
            If pRpt = CheckState.Checked And User_Right = 1 Then
                ErrMsg(er_KoSD)
            Else
        ...
        End Try
    End Sub
    Private Sub bcCongNo_menu_click()
        Try
            If pRpt = CheckState.Checked And User_Right = 1 Then
                ErrMsg(er_KoSD)
                Exit Sub
    ...
    Public Sub GetLicense()
        ...
        Try
            ...
            If rs_license.Rows.Count > 0 Then
                ...
                End If
                Me.Text = "ACTax " & System.String.Format(My.Application.Info.Version.Major, My.Application.Info.Version.Minor, My.Application.Info.Version.Build, My.Application.Info.Version.Revision, 0) & " TT-133/BTC"
                If pVersion = 3 Then
...
kt:
    ...
    Private Sub TreeViewApp_NodeMouseDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.TreeNodeMouseClickEventArgs) Handles TreeViewApp.NodeMouseDoubleClick
        Try
            Me.Cursor = Cursors.WaitCursor
    ...
    Private Sub mainMenuButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNhapChungTuTongHop.Click, btnBaoCaoTongHop.Click, btnBaoCaoChiTiet.Click
        Try
            Dim btnSelect As Button = CType(sender, Button)
            Select Case btnSelect.Name
                Case "btnNhapChungTuTongHop"
                    nhapChungTuContextMenuStrip.Show(btnNhapChungTuTongHop, 0, btnNhapChungTuTongHop.Height)
                    'FrmChungtutonghop.initOption = 0
                    'FrmChungtutonghop.ShowDialog()
                    Exit Select
                Case "btnBaoCaoChiTiet"
                    baoCaoChiTietContextMenuStrip.Show(btnBaoCaoChiTiet, 0, btnBaoCaoChiTiet.Height)
                    Exit Select
                Case "btnBaoCaoTongHop"
                    If pRpt = 1 And User_Right = 1 Then
                        ErrMsg(er_KoSD)
                        Exit Sub
                    End If
